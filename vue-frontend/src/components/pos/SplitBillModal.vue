  ...
  >
    <div class="flex flex-col gap-4 select-none">
      ...
      <div class="flex flex-col gap-2">
        <label class="text-xs font-semibold text-slate-300">Number of Ways to Split</label>
      ...
      <div class="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 flex flex-col gap-2">
        <div class="flex items-center justify-between text-sm">
          <span class="text-slate-400">Each Guest Pays:</span>
          <span class="text-xl font-bold text-cyan-400 font-mono">${{ splitAmount.toFixed(2) }}</span>
        </div>
